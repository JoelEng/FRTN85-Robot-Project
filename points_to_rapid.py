...
def write_plane_calibration():
    ...
    OUTPUT.write("\t\tMoveJ air_1,v10,z1,tool1\WObj:=Workobject_1;\n")
    OUTPUT.write("\t\tSearchL \Stop, DI10_0, sp_1, paper_1, v10, tool1\WObj:=Workobject_1;\n")
    OUTPUT.write("\t\tMoveJ air_2,v10,z1,tool1\WObj:=Workobject_1;\n")
    OUTPUT.write("\t\tSearchL \Stop, DI10_0, sp_2, paper_2, v10, tool1\WObj:=Workobject_1;\n")
    OUTPUT.write("\t\tMoveJ air_3,v10,z1,tool1\WObj:=Workobject_1;\n")
    OUTPUT.write("\t\tSearchL \Stop, DI10_0, sp_3, paper_3, v10, tool1\WObj:=Workobject_1;\n")
    OUTPUT.write("\t\tMoveJ air_3,v10,z1,tool1\WObj:=Workobject_1;\n")
...
def define_constants(path_list, OUTPUT):
    ...
    OUTPUT.write("\tCONST robtarget paper_1:=[[0,50,0],[1,0,0,0],[0,0,-2,0],[9E+09,9E+09,9E+09,9E+09,9E+09,9E+09]];\n")
    OUTPUT.write("\tCONST robtarget paper_2:=[[100,100,0],[1,0,0,0],[0,0,0,0],[9E+09,9E+09,9E+09,9E+09,9E+09,9E+09]];\n")
    OUTPUT.write("\tCONST robtarget paper_3:=[[0,150,0],[1,0,0,0],[0,0,0,0],[9E+09,9E+09,9E+09,9E+09,9E+09,9E+09]];\n")
